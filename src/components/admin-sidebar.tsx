    ...
    <>
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-2 space-y-1">
          ...
          <NavItem href="/dashboard/admin/ai-settings" label="AI Configuration" collapsed={collapsed} icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>} />
